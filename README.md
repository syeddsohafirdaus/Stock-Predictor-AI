...
- `python` tries to install the Python version. This project is built for Python 3.11+.

- `requirements.txt` contains the latest required Python packages.
...
1. First, install Python if you already have Python in your system hit this `python --version` in your terminal or cmd to know the Python version (use Python 3.11 or later).

   -  [python](https://www.python.org/downloads/)  (Here you can find the latest releases of Python)
   - [Python 3.11 downloads](https://www.python.org/downloads/release/python-3110/) (recommended for this project)
...
example: pip install Django==5.2.14
